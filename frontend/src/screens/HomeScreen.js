...
const { keyword, pageNumberParam } = useParams();

  console.log("keyword==>", keyword, pageNumberParam);

  // let pageNumber = keyword.pageNumber || 1
  const [pageNumber, setPageNumber] = useState(pageNumberParam || 1);
